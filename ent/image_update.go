...
func (iu *ImageUpdate) SetDeleted(b bool) *ImageUpdate {
	iu.mutation.SetDeleted(b)
	return iu
}

// SetNillableDeleted sets the "deleted" field if the given value is not nil.
func (iu *ImageUpdate) SetNillableDeleted(b *bool) *ImageUpdate {
	if b != nil {
		iu.SetDeleted(*b)
	}
	return iu
...
// SetDeleted sets the "deleted" field.
func (iuo *ImageUpdateOne) SetDeleted(b bool) *ImageUpdateOne {
	iuo.mutation.SetDeleted(b)
	return iuo
}

// SetNillableDeleted sets the "deleted" field if the given value is not nil.
func (iuo *ImageUpdateOne) SetNillableDeleted(b *bool) *ImageUpdateOne {
	if b != nil {
		iuo.SetDeleted(*b)
	}
	return iuo
